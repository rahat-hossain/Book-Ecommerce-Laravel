								...
								<div class="block-minicart minicart__active">
									<div class="minicart-content-wrapper">
										...
										<div class="total_amount text-right">
											<span>{{ getCartTotalPrice() }} Tk.</span>
										</div>
										...
										<div class="single__items">
											<div class="miniproduct">
												...
												<div class="item01 d-flex mt--20">
													<div class="thumb">
														<a href="product-details.html"><img src="{{ asset('uploads/products_photos') }}/{{ $getCartProduct->relationtoproducttable->product_photo }}" alt="product images"></a>
													</div>
													<div class="content">
														<h6><a href="product-details.html">{{ $getCartProduct->relationtoproducttable->product_name }}</a></h6>
														<span class="prize">{{ $getCartProduct->relationtoproducttable->product_price * $getCartProduct->quantity }} Tk.</span>
